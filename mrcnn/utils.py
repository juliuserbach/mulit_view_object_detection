...
# copied from github tf 2.2.0 keras/layers/normalization
...
# def vec2rot(vec):
#     """ computed the rotation matrix from the three vector eye, look at and up dircetion defined by InteriorNet"""
#     eye = vec[0:3]
#     look_at = vec[3:6]
#     up_dir = vec[6:]
...
#     look_at = look_at - eye
#     up_dir = up_dir -eye
#     R = np.array([np.cross(up_dir, look_at), up_dir, look_at])
#     return R
def normalize(v):
    return v / np.linalg.norm(v)

def vec2rot(view_pose):
